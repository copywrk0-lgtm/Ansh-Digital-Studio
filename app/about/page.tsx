...
export const metadata:Metadata={title:'About the Studio',description:'Ansh Digital Studio has photographed weddings, portraits and celebrations since 2015 with a warm, candid and people-led approach.',alternates:{canonical:'/about'}};
