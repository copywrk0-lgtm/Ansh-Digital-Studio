...
export const metadata:Metadata={title:'Contact & Check Availability',description:'Check Ansh Digital Studio availability for weddings, pre-weddings, portraits, films and events.',alternates:{canonical:'/contact'}};
