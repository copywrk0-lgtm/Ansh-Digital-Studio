...
export const metadata:Metadata={title:'Photography & Videography Services',description:'Wedding photography, candid portraits, pre-weddings, wedding films, maternity, newborn and event coverage by Ansh Digital Studio.'};
